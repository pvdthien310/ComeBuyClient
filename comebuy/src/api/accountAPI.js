...
const accountApi = {
    ...
    register: async (dataForReg) => {
        const res = DatabaseClient.post(`/${baseURL}`, dataForReg).catch((err) => err.response);
        return res;
    },
    ...
    updateAccount: async (data) => {
        const res = DatabaseClient.put(`/${baseURL}/${data.userID}`, data).catch((err) => err.response);
        return res;
    },
    ...
    deleteAccount: async (accountID) => {
        const res = DatabaseClient.delete(`/${baseURL}/${accountID}`).catch((err) => err.response);
        return res;
    },
