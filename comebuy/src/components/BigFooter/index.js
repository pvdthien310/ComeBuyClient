        ...
        <div style={{ display: 'flex' }}>
            ...
            >
                ...
                <p style={{ margin: '20px 0px' }}>
                    ComeBuy is a web store which includes a lot of the best laptop in the world. Come with us, you will
                    never be confused about choosing type, proper price of Laptop you want
                </p>
                <div style={{ display: 'flex' }}>
                    <div
                        style={{
            ...
            >
                ...
                >
                    ...
                    >
                        <Link underline="hover" key="2" style={{ color: 'black', cursor: 'pointer' }} onClick={logOut}>
                            Log out
                        </Link>
                    </li>
                </ul>
