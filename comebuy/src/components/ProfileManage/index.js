...
const images = [
    {
        ...
        imgPath: 'https://www.isaca.org/-/media/images/isacadp/project/isaca/membership-levels/badge-bronze.png',
    },
    {
        label: 'Silver member: ( > or 2000 points and  under 5000 points) You will get an auto-discount for 10%',
        imgPath: 'https://www.isaca.org/-/media/images/isacadp/project/isaca/membership-levels/silver-badge.png',
    },
    {
        label: 'Golden member: ( > or 5000 points and  under 20000 points) You will get an auto-discount for 20%',
        imgPath: 'https://www.isaca.org/-/media/images/isacadp/project/isaca/membership-levels/gold-badge.png',
    },
    {
        label: 'Diamond member: ( > or 20000 points) You will get an auto-discount for 30%',
        imgPath: 'https://www.isaca.org/-/media/images/isacadp/project/isaca/membership-levels/platinum-badge.png',
    },
];
...
function ProfileManage() {
    ...
    const breadcrumbs = [
        ...
        <Link underline="hover" key="2" style={{ color: 'black' }} href="/myplace" onClick={handleClick}>
            My place
        </Link>,
        ...
        >
            ...
            >
                <Stack direction="row" spacing={0.5}>
                    <MemberShipStepper />
                    <IconButton
                        onClick={() => setOpenModalMemberRule(true)}
                        style={{ marginLeft: '-2%', marginTop: '-2.5%', backgroundColor: '#F2EBDF' }}
                    >
                        <MoreIcon />
                    </IconButton>
                </Stack>
                ...
                <Stack direction="row" spacing={2} style={{ width: '100%' }}>
                    ...
                    <IconButton
                        onClick={handleOpenModalChangeContact}
                        style={{
                            marginTop: '-0.5%',
                            backgroundColor: '#F2EBDF',
                            marginLeft: '7%',
            ...
            >
                ...
                <Stack direction="row" spacing={2} style={{ width: '100%' }}>
                    ...
                    <IconButton
                        onClick={handleOpenModalChangeAddress}
                        style={{
                            marginTop: '-0.5%',
                            backgroundColor: '#F2EBDF',
                            marginLeft: '7%',
            ...
            >
                ...
                <Stack direction="row" spacing={2} style={{ width: '100%' }}>
                    <Typography style={{ color: 'black', fontWeight: 'bold', marginTop: '1%', marginLeft: '15%' }}>
                        Birthday:
                    </Typography>
                    <LocalizationProvider dateAdapter={AdapterDateFns}>
                        <MobileDatePicker
                            ...
                            renderInput={(params) => (
                                <TextField style={{ height: '5%', backgroundColor: '#F2EBDF' }} {...params} />
                            )}
                        />
                    </LocalizationProvider>
                    <Typography style={{ color: 'black', fontWeight: 'bold', marginTop: '1%', marginLeft: '3%' }}>
                        Gender:
                    </Typography>
                ...
                >
                    ...
                    {toggleSaveBtn ? (
                        <Stack direction="row" spacing={3} style={{ justifyContent: 'space-between' }}>
                            ...
                            <Button onClick={handleChangeName} style={{ marginLeft: '40%' }}>
                                Save
                            </Button>
                        </Stack>
                    ) : (
                ...
                >
                    ...
                    {toggleSaveContactBtn ? (
                        <Stack direction="row" style={{ justifyContent: 'space-between' }}>
                            ...
                            <Button onClick={handleChangeContact} style={{ marginLeft: '40%' }}>
                                Save
                            </Button>
                        </Stack>
                    ) : (
                ...
                >
                    ...
                    {toggleSaveAddressBtn ? (
                        <Stack direction="row" style={{ justifyContent: 'space-between' }}>
                            ...
                            <Button onClick={handleChangeAddress} style={{ marginLeft: '40%' }}>
                                Save
                            </Button>
                        </Stack>
                    ) : (
            ...
            >
                ...
                >
                    ...
                    >
                        <Typography sx={{ marginBottom: 15, marginTop: 15, padding: 3 }}>
