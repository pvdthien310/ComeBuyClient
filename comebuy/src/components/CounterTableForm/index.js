...
const TableForm = ({
    ...
    useEffect(() => {
        if (currentProduct != null) setOpenModal(true);
    }, [currentProduct]);
    ...
    return (
        <>
            ...
            <table width="100%">
                <thead>
                    <tr style={{ backgroundColor: '#F2F2F2' }}>
                        ...
                        <td style={{ fontWeight: 'bold', fontSize: '17px' }} className="amount">
                            Amount
                        </td>
                    </tr>
                </thead>
                    ...
                    <React.Fragment key={id}>
                        <tbody>
                            <tr className="h-10">
                                ...
                                <td style={{ fontSize: '16px' }} className="amount">
                                    💸{amount}
                                </td>
                                <td>
            ...
            <div>
                <h2 style={{ fontSize: '30px', display: 'flex', justifyContent: 'flex-end' }}>Cost. {total} USD</h2>
            </div>
        </>
    );
};
