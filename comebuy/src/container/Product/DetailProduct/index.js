                ...
                <Grid container item xs={8}>
                    {product != null && error == null ? (
                        <Box sx={style.boxContainer}>
                            ...
                            <Box sx={style.boxDes}>
                                <Stack direction="row" spacing={1} padding={1} sx={style.boxDes_Stack}>
                                    <DescriptionIcon />
                                    <Typography variant="h6" fontWeight="bold">
                                        Description
                                    </Typography>
                        ...
                        {product != null ? (
                            <Stack>
                                ...
                                <CustomButton
                                    ...
                                    variant="filled"
                                    sx={{ color: 'white', backgroundColor: '#D92365', p: 1, mt: 2 }}
                                ...
                                {localStorage.getItem('idUser') !== '' && (
                                    <CustomButton
                                        ...
                                        variant="filled"
                                        sx={{ color: 'white', backgroundColor: '#8C030E', p: 1, mt: 2 }}
                                ...
                                <CustomButton1
                                    variant="filled"
                                    sx={{ p: 1, mt: 2, backgroundColor: 'black', color: 'white' }}
