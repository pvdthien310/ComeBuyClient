        ...
        <Stack sx={style.boxContainer}>
            <Box sx={style.boxInfor}>
                                ...
                                <Stack xs={12} spacing={2} padding={2}>
                                    ...
                                    >
                                        ...
                                        <Typography fontWeight="bold" variant="body1" color="#BF0426">
                                            One manager must connect to one branch. Confirm to create a manager that
                                            means you are creating a branch too. Please check carefully!
                                        </Typography>
                                    </Stack>
                                    <TextFieldForAdd
                                        inputConfig="text"
                ...
                <Stack sx={{ width: '100%', justifyContent: 'center' }} direction="row" spacing={3}>
                    ...
                    <Button sx={style.SaveButton} variant="contained" onClick={() => setOpenConfirmDialog(true)}>
                        Save
                    </Button>
                </Stack>
            </Box>
